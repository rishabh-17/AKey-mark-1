...
def home(request):
    ...
    day = date.strftime("%d")
    context['Employees'] = models.Employees.objects.filter(
...
def Employees(request):
    context = context_data(request)
    context['page'] = 'Employees'
    context['page_title'] = "Employee List"
    context['Employees'] = models.Employees.objects.all()
...
def save_Employee(request):
    ...
    if request.method == 'POST':
        post = request.POST
        if not post['id'] == '':
            Employee = models.Employees.objects.get(id = post['id'])
...
def manage_Employee(request, pk = None):
    ...
    if pk is None:
        ...
        context['Employee'] = models.Employees.objects.get(id=pk)
...
def view_Employee(request, pk = None):
    context = context_data(request)
    context['page'] = 'manage_Employee'
    context['page_title'] = 'View Employee Log'
    if pk is None:
        context['Employee'] = {}
    else:
        context['Employee'] = models.Employees.objects.get(id=pk)
...
def delete_Employee(request, pk = None):
    ...
    if pk is None:
        ...
        try:
            models.Employees.objects.filter(pk = pk).delete()
...
def report(request):
    context = context_data(request)
    context['page'] = 'Employees'
    context['page_title'] = "Daily Employee Logs Report"
